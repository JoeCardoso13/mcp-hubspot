...
1. **Add response models** to `src/mcp_hubspot/api_models.py`
2. **Add client methods** to `src/mcp_hubspot/api_client.py`
3. **Add the tool** to `src/mcp_hubspot/server.py` using `@mcp.tool()`
